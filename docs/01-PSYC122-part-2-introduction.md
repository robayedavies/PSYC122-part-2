...
We will complete a series of four classes in weeks 16-19.
...
This research is needed because it is important to ensure that health advice can be understood but existing evidence can tell us little about how advice should be written so that everyone who reads the advice can understand it.

We will present our PSYC122 lessons in the context of this research project because we think that this will help you to make sense of the data, and of what we ask you to do.
...
And we will be extending your development with some new ideas.

Ultimately, our aim will be to contribute new findings from data we collect with your help.
These new findings will, we hope, help to make the provision of health advice a bit more useful in future.

## Our learning goals

In Week 16, we aim to further develop your skills in working with psychological data.
We will learn how to answer research questions like:
...
In Week 16, we will consolidate learning on **data visualization**:

- Using histograms to examine the distributions of variables;
- Learning to edit the histograms so they are more effective.
...
Everything you need for a practical class can also be found in the **Week 16 files** folder on Moodle, here:
...
In the classes, we can then analyze the data we collect.
