...
Welcome to the materials and guidance you will work with in **PSYC122 Week 16**.
...
We encounter written health information all the time: in COVID warnings signs, on medication labels, in clinics when we go to see the doctor, and online when we research things we are worried about.
...
Download the `122_week16_forStudents.zip` folder and upload it to RStudio Server.
...
The guide includes an .R file `2021-22-PSYC122-w16-how-to.R` with code and advice, and a video showing you how the code works.
The code in the .R file was written to work with the data file `study-one-general-participants.csv`.
You can find both the `2021-22-PSYC122-w16-how-to.R` and the `study-one-general-participants.csv` files in the `122_week16_forStudents.zip` folder.
